// ==UserScript==
// @name         HoorayHug Image上传脚本
// @namespace    https://hoorayhug.example/
// @version      0.22
// @description  HoorayHug Image快捷上传工具
// @author       HoorayHug
// @match        http://*/*
// @match        https://*/*
// @license      GPL
...
(function() {
    ...
    function imgurl(){
	    //使用原生js添加按钮
	    var div = document.createElement("div");
	    div.innerHTML = '<div id = "imgbtn" title="HoorayHug Image" style = "position:fixed;right:1em;bottom:1em;z-index:88;cursor:pointer;width:36px;height:36px;line-height:36px;text-align:center;background:#0f766e;color:#fff;border-radius:4px;font-weight:bold;" onclick = "showImgurl()">HI</div>';
	    document.body.appendChild(div);
    }
    //显示上传按钮
    window.showImgurl = function(){
	    var up = layerstart;
	    up += '<iframe src = "https://hoorayhug.example/" width="100%" height="660px" frameborder="0"></iframe>';
	    up += layerend;
	    //$("body").append(up);
	    var div = document.createElement("div");
	    div.innerHTML = up;
